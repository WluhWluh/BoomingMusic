...
class SourceSeparationStemIconResolverTest {
    ...
    fun `published MDX stem labels use the frozen icon mapping`() {
        val expected = mapOf(
            ...
            "Instrumental" to R.drawable.ic_music_note_24dp,
            ...
            "Reverb" to R.drawable.ic_surround_sound_24dp,
            "No Crowd" to R.drawable.ic_music_note_24dp,
            "Crowd" to R.drawable.ic_groups_24dp,
