...
internal object SourceSeparationDebugProtocol {
    ...
    val commands = linkedMapOf(
        ...
        "settings.set" to listOf(
            ...
            "auto_flac:boolean?",
            "compression_format:string? (none|flac|aac_lc_160k)",
            "snackbar_progress:boolean?",
            "snackbar_messages:boolean?",
            "preroll_ms:long?",
            "aac_seek_ready_frames:int? (0=off)",
            "aac_seek_block_frames:int? (512..4096)",
            "aac_seek_mode:string? (previous|closest|next)",
            "ready_windows:int?",
